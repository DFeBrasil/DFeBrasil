...
public class NFeParserTests
{
    ...
    [Fact]
    public void ParseText_ComStringXML_RetornaDhEmi()
    {
        // Arrange
        var xmlString = ObterXmlFakeNfceNFeProc();
        ...
        // Assert
        Assert.Equal("2022-04-17T17:31:26-03:00", result.NFe.InfNFe.Ide.DhEmiString);
        Assert.Equal("2022-04-17T17:31:26-03:00", result.NFe.InfNFe.Ide.DhEmi.ToString("yyyy-MM-ddTHH:mm:sszzz"));
    }
    
    [Fact]
    public void ParseText_ComStringXML_RetornaDhRecbto()
    {
        // Arrange
        var xmlString = ObterXmlFakeNfceNFeProc();
        ...
        // Assert
        Assert.Equal("2022-04-14T14:06:54-03:00", result.ProtNFe.InfProt.DhRecbtoString);
        Assert.Equal("2022-04-14T14:06:54-03:00", result.ProtNFe.InfProt.DhRecbto.ToString("yyyy-MM-ddTHH:mm:sszzz"));
    }
}